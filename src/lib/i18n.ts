...
export const DICT = {
  fr: {
    ...
    projects: {
      ...
      subtitle: 'Des outils SaaS pensés pour les professionnels — en production, en test ou en cours de développement.',
      live: 'En ligne',
      test: 'En test',
      soon: 'Bientôt',
      view: 'Voir le projet',
      testView: 'Tester',
      protected: 'Accès sur identifiants',
      ...
      items: [
        ...
        { baseline: 'Site citoyen neutre et sourcé — présidentielle 2027', description: 'Qui gouverne, qui se présente, qu’ont-ils fait, où en est le pays — avec compte à rebours jusqu’au scrutin. 100 % sourcé.' },
  ...
  en: {
    ...
    projects: {
      title: 'What I build',
      subtitle: 'SaaS tools designed for professionals — in production, in testing or under development.',
      live: 'Live',
      test: 'In testing',
      soon: 'Soon',
      view: 'View project',
      ...
      items: [
        ...
        { baseline: 'Neutral, sourced civic site — 2027 French election', description: 'Who governs, who is running, what they did, the state of the country — with a countdown to the vote. 100% sourced.' },
