...
export const DICT = {
  fr: {
    ...
    cv: {
      title: 'Recevoir mon CV',
      intro: 'Renseignez votre demande : je vous transmets le CV et je suis informé de votre intérêt.',
      profileLabel: 'Profil',
      profiles: { as400: 'AS400 / JD Edwards', reconversion: 'Reconversion (no-code / IA)' },
      name: 'Nom',
      firstName: 'Prénom',
      email: 'Email',
      role: 'Fonction',
      rolePlaceholder: 'Recruteur, RH, dirigeant…',
      formatLabel: 'Quel CV ?',
      formatPlaceholder: 'Choisir un format…',
      formats: {
        presentation: { label: 'Présentation (2 colonnes)', desc: 'Élégant, 1 page — pour un envoi direct à un humain.' },
        ats: { label: 'ATS', desc: '1 colonne, 2 pages — lisible par les logiciels de recrutement.' },
        ats100: { label: 'ATS 100 %', desc: 'Noir & blanc, structure stricte — robots de tri exigeants.' },
        design: { label: 'Design', desc: 'Version soignée — pour un forum ou un partage.' },
      },
      reason: 'Pourquoi ?',
      reasonPlaceholder: 'Contexte de votre demande…',
      consent: 'J’accepte que mes informations soient conservées pour traiter ma demande.',
      privacy: 'Données utilisées uniquement pour répondre à votre demande, conservées 6 mois puis supprimées — aucune revente.',
      optional: 'optionnel',
      submit: 'Recevoir le CV',
      sending: 'Envoi…',
      ok: 'Merci ! Votre téléchargement démarre. Votre demande m’a bien été transmise.',
      download: 'Télécharger le CV',
      error: 'Envoi impossible pour le moment. Réessayez ou écrivez-moi à contact@no-code-hub.fr.',
      invalid: 'Merci de renseigner votre nom, un email valide, un format, et de cocher le consentement.',
      close: 'Fermer',
    },
    footer: {
  ...
  en: {
    ...
    cv: {
      title: 'Get my résumé',
      intro: 'Fill in your request: I’ll send you the résumé and I’m notified of your interest.',
      profileLabel: 'Profile',
      profiles: { as400: 'AS400 / JD Edwards', reconversion: 'Career change (no-code / AI)' },
      name: 'Last name',
      firstName: 'First name',
      email: 'Email',
      role: 'Role',
      rolePlaceholder: 'Recruiter, HR, executive…',
      formatLabel: 'Which résumé?',
      formatPlaceholder: 'Choose a format…',
      formats: {
        presentation: { label: 'Presentation (2 columns)', desc: 'Elegant, 1 page — for sending directly to a person.' },
        ats: { label: 'ATS', desc: '1 column, 2 pages — readable by recruiting software.' },
        ats100: { label: 'ATS 100%', desc: 'Black & white, strict structure — demanding screening bots.' },
        design: { label: 'Design', desc: 'Polished version — for a forum or sharing.' },
      },
      reason: 'Why?',
      reasonPlaceholder: 'Context of your request…',
      consent: 'I agree that my information may be kept to process my request.',
      privacy: 'Data used only to answer your request, kept for 6 months then deleted — never resold.',
      optional: 'optional',
      submit: 'Get the résumé',
      sending: 'Sending…',
      ok: 'Thank you! Your download is starting. Your request has been sent to me.',
      download: 'Download the résumé',
      error: 'Sending failed for now. Try again or email me at contact@no-code-hub.fr.',
      invalid: 'Please provide your name, a valid email, a format, and tick the consent box.',
      close: 'Close',
    },
    footer: {
